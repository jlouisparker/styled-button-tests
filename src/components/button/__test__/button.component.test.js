...
describe('button tests', () => {
  test('should render base button when nothing is passed', () => {
    ...
    // const baseButtonElement = screen.getByText(/test/i);
    const baseButtonElement = screen.getByRole('button');

    // console.log(baseButtonElement);

    //console.log(getComputedStyle(baseButtonElement));
    
    expect(baseButtonElement).toHaveStyle('background-color: black');
  });
